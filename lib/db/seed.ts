...
const TRAMITES_DATA = [
  ...
  },
  {
    ...
    plazoLabel:   '30 días hábiles',
    diasCount:    30,
    tipoCompute:  'habiles' as const,
    articuloLey:  'Art. 70 LRJS',
    descripcion:  'Art. 70 LRJS — 30 días hábiles desde la fecha del hecho causante o desde la notificación de la resolución empresarial. Requisito previo obligatorio en determinados supuestos frente a Administraciones Públicas.',
    ordenDisplay: 1,
    activo:       true,
  },
  {
